...
- (NSUInteger)numberOfPlaceholdersInCarousel:(ECAdCarousel *)carousel;
- (UIView *)carousel:(ECAdCarousel *)carousel placeholderViewAtIndex:(NSUInteger)index reusingView:(UIView *)view;
...
- (void)carouselWillBeginScrollingAnimation:(ECAdCarousel *)carousel;
- (void)carouselDidEndScrollingAnimation:(ECAdCarousel *)carousel;
- (void)carouselDidScroll:(ECAdCarousel *)carousel;
- (void)carouselCurrentItemIndexDidChange:(ECAdCarousel *)carousel;
- (void)carouselWillBeginDragging:(ECAdCarousel *)carousel;
- (void)carouselDidEndDragging:(ECAdCarousel *)carousel willDecelerate:(BOOL)decelerate;
- (void)carouselWillBeginDecelerating:(ECAdCarousel *)carousel;
- (void)carouselDidEndDecelerating:(ECAdCarousel *)carousel;

- (BOOL)carousel:(ECAdCarousel *)carousel shouldSelectItemAtIndex:(NSInteger)index;
- (void)carousel:(ECAdCarousel *)carousel didSelectItemAtIndex:(NSInteger)index;

- (CGFloat)carouselItemWidth:(ECAdCarousel *)carousel;
- (CATransform3D)carousel:(ECAdCarousel *)carousel itemTransformForOffset:(CGFloat)offset baseTransform:(CATransform3D)transform;
- (CGFloat)carousel:(ECAdCarousel *)carousel valueForOption:(iCarouselOption)option withDefault:(CGFloat)value;
...
- (NSUInteger)numberOfVisibleItemsInCarousel:(ECAdCarousel *)carousel;
- (void)carouselCurrentItemIndexUpdated:(ECAdCarousel *)carousel __attribute__((deprecated));
- (BOOL)carouselShouldWrap:(ECAdCarousel *)carousel __attribute__((deprecated));
- (CGFloat)carouselOffsetMultiplier:(ECAdCarousel *)carousel __attribute__((deprecated));
- (CGFloat)carousel:(ECAdCarousel *)carousel itemAlphaForOffset:(CGFloat)offset __attribute__((deprecated));
- (CGFloat)carousel:(ECAdCarousel *)carousel valueForTransformOption:(iCarouselOption)option withDefault:(CGFloat)value __attribute__((deprecated));
